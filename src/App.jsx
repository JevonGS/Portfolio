          ...
          <div>
              <div>
                ...
                <div data-aos="fade-up" className='flex md:justify-between gap-5 md:mt-5 lg:mt-15 mt-10' style={{width:'100%'}}>
                  <a href="/CV-Jevon.pdf" download className='w-full'><button className='bg-white text-gray-900 w-full rounded-xl text-base font-bold cursor-pointer hover:bg-transparent hover:text-white' style={{padding: 20, border:"solid white 1px"}}>Download CV</button></a>
